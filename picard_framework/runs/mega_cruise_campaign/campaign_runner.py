...
# Canonical ship-class populations for multi-platform calibration (c1–c6).
...
def generate_tier_runs(
    ...
    *,
    ...
    elif short in ("c1", "c2", "c3", "c4", "c5", "c6"):
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--tier", default=None, help="Tier id or short prefix (t1…t16, c1…c6)")

...
| `submit_boundary_surface.ps1` | Submit `boundary_surface_v1` Tier-1 Spot array (b1_*; b2_* deferred). | — |
| `Dockerfile.analysis` | CmdStan analysis image for surface / Stan / MC (not Spot ABM). | — |

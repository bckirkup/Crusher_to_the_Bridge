...
from simulation_utils.paths import REPO_ROOT as REPO  # noqa: E402
...
def tos_spatial() -> dict:
    zones = [
        ...
        ("Transporter", "Free", "low", 90, "saucer_primary", 78, 28, "Personnel transporter"),
        ...
        ("Security", "Free", "low", 95, "saucer_primary", 72, 35, "Security and brig access"),
        ("Crew_Quarters", "Room", "medium", 480, "saucer_primary", 42, 8, "Enlisted berthing"),
        ("OfficerQtrs", "Room", "low", 320, "saucer_primary", 48, 22, "Officer staterooms"),
...
def tos_airflow() -> dict:
    return {
        ...
        "hvac_zones": [
            ...
            {
                "id": "zone_saucer_ops",
                "rooms": ["Sickbay", "Security", "Transporter", "Science_Lab"],
                "ach": 10.0,
                "description": "Mid-saucer operational deck",
            },
            {
                "id": "zone_saucer_living",
                "rooms": ["Rec_Deck", "Galley", "Crew_Quarters", "OfficerQtrs"],
                "ach": 7.0,
        ...
        "adjacency": [
            ...
            {"from": "Sickbay", "to": "Transporter", "type": "passageway"},
            {"from": "Sickbay", "to": "Security", "type": "passageway"},
            ...
            {"from": "Crew_Quarters", "to": "OfficerQtrs", "type": "passageway"},
            {"from": "OfficerQtrs", "to": "Engineering", "type": "turbolift"},
...
def tng_spatial() -> dict:
    zones = [
        ...
        ("MainEng", "Room", "high", 680, "drive_section", 50, 45, "Warp core and EPS"),
        ...
        ("StellarCarto", "Free", "low", 180, "saucer_16", 100, 38, "Stellar cartography"),
...
def tng_airflow() -> dict:
    return {
        ...
        "hvac_zones": [
            {
                "id": "zone_saucer_command",
                "rooms": ["Bridge", "StellarCarto", "Security_Office"],
                "ach": 9.0,
            },
            {
        ...
        "adjacency": [
            {"from": "Bridge", "to": "StellarCarto", "type": "turbolift"},
            ...
            {"from": "Cargo_Bay", "to": "MainEng", "type": "turbolift"},
            {"from": "MainEng", "to": "Sickbay", "type": "turbolift"},
...
def tos_template() -> dict:
    return {
        ...
        "agent_classes": [
            {"class_id": "crew_command", "role_group": "crew", "fraction": 0.08, "home_zone_preference": "OfficerQtrs", "free_zone_preference": "Bridge", "duty_zone": "Bridge"},
            ...
            {"class_id": "crew_security", "role_group": "crew", "fraction": 0.08, "home_zone_preference": "Crew_Quarters", "free_zone_preference": "Security", "duty_zone": "Security"},
            ...
            {"class_id": "crew_sciences", "role_group": "crew", "fraction": 0.12, "home_zone_preference": "OfficerQtrs", "free_zone_preference": "Science", "duty_zone": "Science_Lab"},
            {"class_id": "crew_medical", "role_group": "crew", "fraction": 0.08, "home_zone_preference": "OfficerQtrs", "free_zone_preference": "Sickbay", "duty_zone": "Sickbay"},
...
def tng_template() -> dict:
    return {
        ...
        "recommended_ship_graph": {
            ...
            "graywater_zones": ["MainEng", "Cargo_Bay"],
        },
        "agent_classes": [
            ...
            {"class_id": "crew_engineering", "role_group": "crew", "fraction": 0.15, "home_zone_preference": "Crew_Quarters", "free_zone_preference": "Engineering", "duty_zone": "MainEng"},

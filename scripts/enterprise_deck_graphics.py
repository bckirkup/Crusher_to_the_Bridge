...
def galaxy_tng_geojson() -> dict[str, Any]:
    ...
    zones = {
        ...
        "MainEng": ([42, 40], [58, 40], [58, 50], [42, 50]),
        ...
        "StellarCarto": ([96, 34], [108, 34], [108, 42], [96, 42]),
...
def constitution_tos_geojson() -> dict[str, Any]:
    ...
    zones = {
        ...
        "Transporter": ([72, 24], [84, 24], [84, 32], [72, 32]),
        ...
        "Security": ([68, 32], [78, 32], [78, 38], [68, 38]),
        "Crew_Quarters": ([38, 4], [52, 4], [52, 12], [38, 12]),
        "OfficerQtrs": ([44, 18], [56, 18], [56, 26], [44, 26]),

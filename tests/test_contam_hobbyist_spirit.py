"""Hobbyist Contam bootstrap for spirit_cruise_3000."""
...
def test_spirit_hobbyist_export() -> None:
    ...
    assert len(path_map) >= 400


def test_spirit_bundled_hobbyist_prj() -> None:

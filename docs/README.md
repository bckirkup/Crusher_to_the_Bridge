...
| [norovirus/route_attribution_headcount_scaling.md](norovirus/route_attribution_headcount_scaling.md) | Measurement of record — `hull_compounding_route_v1` attributes all 1,800 Arm B re-run voyages to routes: droplet carries 85–99% of establishments and the whole N^1.7–2.0 per-import headcount scaling; direct contact is inert |

...
| [covid/covid_theta_handoff_2026_09_21.md](covid/covid_theta_handoff_2026_09_21.md) | Handoff record (2026-09-21) — successor to the 09-19 record: the THETA-SCREEN-V10 canary closed, what it does and does not license, terminal AWS job IDs and S3 prefix, and the single open decision (do the remaining 180 cells run). Numbers live in the ledger entries it cites |
| [covid/covid_theta_screen_v10_readout.md](covid/covid_theta_screen_v10_readout.md) | Findings (2026-09-21) — the v10 canary: Θ 1e9 × 20 seeds on the post-QUAR-EXEMPT-01/REINFECT-01 engine reproduces the v9 row seed-for-seed and the shared-seed cell of record exactly; nine decades unmeasured, `covid.T3` flips on the same bimodal span |

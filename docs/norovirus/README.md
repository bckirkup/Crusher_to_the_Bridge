...
| [bounded_screen_isolated_36.md](bounded_screen_isolated_36.md) | Measurement (2026-09-05) | The Morris screen on the rebuilt model and the current six-factor box, with the other bundle pathogens' seeds suppressed: one factor resolves above the noise floor, five do not, and nothing is bounded |

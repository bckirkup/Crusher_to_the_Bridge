...
Every exploratory, confirmatory, revision, review-response, or qualification campaign receives a UUID and records its paper, intent, exact source tree, resolved environment, hashed inputs, effective configuration, seed policy, and parent/supersession lineage.

...
| `campaign-results-analysis` | Analysis bundle + two-stage Stan hurdle (outbreak + trajectory), aggregate summaries, epidemic curves, Batch failure classification after sync |

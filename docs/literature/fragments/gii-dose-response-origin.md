# Register fragment — the GII α interval's origins: one endpoint body-verified, the other abstract-only, and the shipped pair's own source unreached (tranche 19)

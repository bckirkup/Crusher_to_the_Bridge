...
§3.1 (norovirus, active arm). **Merged into the register by the sourcing-wave-1
integration pass; kept as the audit trail, and where it and the register differ the
register holds the status.** Evidence and provenance are in

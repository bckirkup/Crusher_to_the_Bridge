...
**Status:** Merged additive fragment from task #53, tranche 11; kept as the audit trail:
the row below is a **proposal** for
[`docs/parameter_provenance_register.md`](../../parameter_provenance_register.md),
merged by the sourcing-wave-1 integration pass with the other fragments. This file changes
